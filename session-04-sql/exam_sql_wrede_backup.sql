...
\restrict uMsaYWcqxKEKwLqySFVtDGbeUwpodzMZTSoUBeuT4e4wd4KnSaz66RXzkefifgg
...
CREATE TABLE public.anime (
    ...
    score numeric(4,2),
    episodes integer,
    aired character varying(100),
    premiered character varying(30),
...
ALTER TABLE public.producer ALTER COLUMN producer_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.producer_producer_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: source_source_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--
...
ALTER TABLE public.studio ALTER COLUMN studio_id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: type; Type: TABLE; Schema: public; Owner: daniel
--
...
ALTER TABLE public.type OWNER TO daniel;

--
-- Name: type_type_id_seq; Type: SEQUENCE; Schema: public; Owner: daniel
--

ALTER TABLE public.type ALTER COLUMN type_id ADD GENERATED ALWAYS AS IDENTITY (
...
COPY public.anime (anime_id, english_name, score, episodes, aired, premiered, duration, rating, ranked, popularity, type_id, source_id) FROM stdin;
1	Cowboy Bebop	8.78	26	Apr 3, 1998 to Apr 24, 1999	Spring 1998	24 min. per ep	R - 17+ (violence & profanity)	28	39	1	1
2	Cowboy Bebop:The Movie	8.39	1	Sep 1, 2001	\N	1 hr. 55 min.	R - 17+ (violence & profanity)	159	518	2	1
3	Naruto	7.91	220	Oct 3, 2002 to Feb 8, 2007	Fall 2002	23 min. per ep.	PG-13 - Teens 13 or older	660	8	1	2
4	One Piece	8.52	\N	Oct 20, 1999 to ?	Fall 1999	24 min.	PG-13 - Teens 13 or older	95	31	1	2
5	Mobile Suit Gundam SEED	7.79	50	Oct 5, 2002 to Sep 27, 2003	Fall 2002	24 min. per ep.	R - 17+ (violence & profanity)	850	1057	1	1
6	Mobile Suit Gundam SEED Destiny	7.22	50	Oct 9, 2004 to Oct 1, 2005	Fall 2004	24 min. per ep.	R - 17+ (violence & profanity)	2687	1530	1	1
\.
...
COPY public.anime_producer (anime_id, producer_id) FROM stdin;
1	1
2	1
2	2
3	3
...
--
-- Data for Name: type; Type: TABLE DATA; Schema: public; Owner: daniel
--
...
SELECT pg_catalog.setval('public.producer_producer_id_seq', 7, true);


--
-- Name: source_source_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--

SELECT pg_catalog.setval('public.source_source_id_seq', 2, true);
...
--
-- Name: type_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: daniel
--
...
ALTER TABLE ONLY public.anime_producer
    ADD CONSTRAINT anime_producer_pkey PRIMARY KEY (anime_id, producer_id);
...
--
-- Name: genre genre_name_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- Name: producer producer_name_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- Name: source source_name_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- Name: studio studio_name_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- Name: type type_name_key; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
--
-- Name: type type_pkey; Type: CONSTRAINT; Schema: public; Owner: daniel
--
...
ALTER TABLE ONLY public.anime_producer
    ADD CONSTRAINT anime_producer_anime_id_fkey FOREIGN KEY (anime_id) REFERENCES public.anime(anime_id);
...
ALTER TABLE ONLY public.anime_producer
    ADD CONSTRAINT anime_producer_producer_id_fkey FOREIGN KEY (producer_id) REFERENCES public.producer(producer_id);
...
ALTER TABLE ONLY public.anime_studio
    ADD CONSTRAINT anime_studio_anime_id_fkey FOREIGN KEY (anime_id) REFERENCES public.anime(anime_id);
...
ALTER TABLE ONLY public.anime_studio
    ADD CONSTRAINT anime_studio_studio_id_fkey FOREIGN KEY (studio_id) REFERENCES public.studio(studio_id);


--
-- Name: anime fk_anime_source; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.anime
    ADD CONSTRAINT fk_anime_source FOREIGN KEY (source_id) REFERENCES public.source(source_id);


--
-- Name: anime fk_anime_type; Type: FK CONSTRAINT; Schema: public; Owner: daniel
--

ALTER TABLE ONLY public.anime
    ADD CONSTRAINT fk_anime_type FOREIGN KEY (type_id) REFERENCES public.type(type_id);
...
\unrestrict uMsaYWcqxKEKwLqySFVtDGbeUwpodzMZTSoUBeuT4e4wd4KnSaz66RXzkefifgg
